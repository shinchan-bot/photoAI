/*
  ...
  - The values [Generated] on the enum `ModelTrainingPendingStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."ModelTrainingPendingStatus_new" AS ENUM ('Pending', 'Completed', 'Failed');
